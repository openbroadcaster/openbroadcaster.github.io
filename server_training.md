...
1.Search for a specific ID and drag and drop into the playlist, or. 
2.Create a dynamic segment of many station IDs select __admin__ > __player manager__ and __expand__, selecting your station. 
* Drag the selected ID from the media sidebar to __Station IDs (drag media here)__.
 * Select __Save__. Back in the playlist you now select __Add Station ID__ to create a dynamic segment that will change with every play. 
