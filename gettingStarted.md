...
### Setting audio modes
From the Audio/Visualization tab on the Dashboard, select the desired audio mode. To pass thru audio input from an external source, enable the 'Enable Audio In Source' setting. When changing audio modes, a reboot is recommended. 
